...
struct XboxCloudWebView: UIViewRepresentable {
        ...
        function ensurePad(p) {
            ...
            try {
                if (p.vibrationActuator) { wrapActuator(p.vibrationActuator); }
                    ...
                    try { Object.defineProperty(p, 'vibrationActuator', { value: poly, configurable: true, writable: true }); }
                    catch (e1) { try { p.vibrationActuator = poly; } catch (e2) {} }
                }
                if (p.hapticActuators && p.hapticActuators.length) {
                    ...
                    try { Object.defineProperty(p, 'hapticActuators', { value: list, configurable: true, writable: true }); }
                    catch (e3) { try { p.hapticActuators = list; } catch (e4) {} }
                }
            } catch (e) {}
        }
            ...
            try {
                ...
                if (originalGet) {
                    navigator.getGamepads = function() {
                        ...
                        try { for (var i = 0; i < pads.length; i++) ensurePad(pads[i]); } catch (e) {}
                        return pads;
                    };
                }
            } catch (e) {}
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        if bxPrefs["controller.vibration"] == nil { bxPrefs["controller.vibration"] = "true" }
        if bxPrefs["native-mfi-controller.vibration"] == nil { bxPrefs["native-mfi-controller.vibration"] = "true" }
    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKScriptMessageHandler {
        ...
        func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
            ...
            case "rumble":
                ...
                Task { @MainActor in
                    ControllerRumble.shared.play(weak: weakMag, strong: strongMag, durationMs: duration)
                }
            default:
                break
            }
