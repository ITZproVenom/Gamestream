...
struct XboxCloudWebView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        // Full Better xCloud script if already cached (reliable path)
        ...
        // Bridge for streaming state + URL updates
        ...
        // If script wasn't cached yet, fetch then hard-inject
...
final class BetterXCloudInjector {
    ...
    private static func stripUserScriptHeader(_ source: String) -> String {
        // Remove // ==UserScript== ... // ==/UserScript== block so it runs cleanly as plain JS
